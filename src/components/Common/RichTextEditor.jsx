    ...
    renderHTML({ HTMLAttributes }) {
        ...
        if (title) {
            return [
                ...
                ['img', imgAttrs],
                ['figcaption', { style: 'margin-top: 4px; color: var(--hse-gray, #808080); font-family: "HSE Slab", Georgia, 'Times New Roman', serif; font-size: 12px; font-style: italic; text-align: left;' }, title]
            ];
        }
        return ['img', imgAttrs];
    },
