...
import { UserOutlined, LogoutOutlined, AppstoreOutlined, FileTextOutlined } from '@ant-design/icons';
...
const MainLayout = () => {
    ...
    return (
        <Layout style={{ minHeight: '100vh' }}>
            <Header style={{ color: 'var(--hse-green-accent)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <Layout>
                <Sider width={250} theme="light">
                    <Menu
                        ...
                        items={[
                            { key: '/', icon: <AppstoreOutlined />, label: 'Все страницы' },
                            { key: '/my', icon: <FileTextOutlined />, label: 'Мои страницы' },
                        ]}
