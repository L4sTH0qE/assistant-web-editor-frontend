        ...
        return (
            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh', background: '#f0f2f5' }}>
                <Result
                    ...
                    subTitle={<span style={{ fontFamily: 'HSE Sans', fontSize: '16px' }}>Помощник редакторов сайтов подразделений НИУ ВШЭ является сложным профессиональным инструментом. Пожалуйста, откройте приложение с компьютера или ноутбука.</span>}
                />
            </div>
        );
    }
